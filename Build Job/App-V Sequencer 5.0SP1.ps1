# Start Application Virtualization 5.0 Sequencer with Service Pack 1 Build ########################
Write-Output 'Installing Application Virtualization 5.0 Sequencer with Service Pack 1.'
VMR_RunModule -Module Framework\Module_Software-App-V-Sequencer5.0SP1.ps1
