# Start Application Virtualization 5.1 Client with Hotfix 9 Build #################################
...
Write-Output 'Installing Application Virtualization 5.1, Hotfix 9.'
VMR_RunModule -Module Framework\Module_Software-App-V-Client5.1HF9.ps1
