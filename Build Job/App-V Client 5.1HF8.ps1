# Start Application Virtualization 5.1 Client with Hotfix 8 Build #################################
...
Write-Output 'Installing Application Virtualization 5.1, Hotfix 8.'
VMR_RunModule -Module Framework\Module_Software-App-V-Client5.1HF8.ps1
