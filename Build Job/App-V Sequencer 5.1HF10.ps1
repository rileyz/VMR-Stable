# Start Application Virtualization 5.1 Sequencer with Hotfix 10 Build ############################################
Write-Output 'Installing Application Virtualization 5.1 Sequencer with Hotfix 10.'
VMR_RunModule -Module Framework\Module_Software-App-V-Sequencer5.1HF10.ps1
