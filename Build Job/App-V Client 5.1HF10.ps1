# Start Application Virtualization 5.1 Client with Hotfix 10 Build #################################
...
Write-Output 'Installing Application Virtualization 5.1, Hotfix 10.'
VMR_RunModule -Module Framework\Module_Software-App-V-Client5.1HF10.ps1
