...
# Script Assets ###################################################################################
# Asset: AppV5.1RTM_Client_KB4041137.exe
...
$Process = Start-Process -FilePath $VMRCollateral\AppV5.1RTM_Client_KB4041137.exe -ArgumentList '/q /AcceptEULA /CEIPOPTIN=0 /MUOPTIN=0 /NoRestart' -Wait -PassThru
